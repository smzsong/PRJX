...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AClientGameMode_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_AClientGameMode_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_AClientGameMode()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_AClientGameMode_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(AClientGameMode, 2436725714);
	template<> CLIENT_API UClass* StaticClass<AClientGameMode>()
	{
		return AClientGameMode::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AClientGameMode(Z_Construct_UClass_AClientGameMode, &AClientGameMode::StaticClass, TEXT("/Script/Client"), TEXT("AClientGameMode"), false, nullptr, nullptr, nullptr);
